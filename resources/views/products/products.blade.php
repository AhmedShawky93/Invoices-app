                            ...
                            <tbody>
                                @foreach ($products as $product)
                                    <tr>
                                        ...
                                        <td>{{ optional($product->section)->section_name }}</td>
                ...
                <div class="modal-body">
                    <form action="products/update" method="post" autocomplete="off">
                        ...
                        <div class="form-group">
                            <label for="product_name_edit" class="col-form-label">اسم المنتج:</label>
                            <input class="form-control" name="product_name" id="product_name_edit" type="text" required>
                        </div>
                        <div class="form-group">
                            <label for="section_id_edit" class="col-form-label">القسم:</label>
                        ...
                        <div class="form-group">
                            <label for="description_edit" class="col-form-label">ملاحظات:</label>
